...
```bash
https://github.com/GitForAndrey/CRUD-API/tree/develop // or via HTTP
```
...
Before you start project, rename the .env.example file to .env its important for work with project
